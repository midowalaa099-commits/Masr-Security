        ...
        <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
            <div class="space-y-6 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                ...
                <div>
                    ...
                    <x-text-input id="stock_quantity" type="number" name="stock_quantity" class="mt-1 block w-full" :value="old('stock_quantity', $product->stock_quantity)" placeholder="{{ __('admin.none') }}" />
